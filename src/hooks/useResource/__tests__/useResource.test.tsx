...
describe('useResource', () => {
  ...
  it.skip('should return the default resource', () => {
    const { result } = renderHook(() => useResource(options));
    expect(result.current.resource).toEqual({});
  });

  it.skip('should call onLoad with the correct options', async () => {
  ...
  it.skip('should set the resource when onLoad resolves', async () => {
    const { result, waitForNextUpdate } = renderHook(() => useResource(options));
    act(() => {
      result.current.load({});
    });
  ...
  it.skip('should set isLoading to true while the resource is being loaded', async () => {
    const { result, waitForNextUpdate } = renderHook(() => useResource(options));
  ...
  it.skip('should set error when onLoad rejects', async () => {
  ...
  it.skip('should cancel the previous load when load is called again', async () => {
    const { result, waitForNextUpdate } = renderHook(() => useResource(options));
    act(() => {
      result.current.load({});
      result.current.load({});
  ...
  it.skip('should cancel the current load when cancelLoad is called', async () => {
    const { result, waitForNextUpdate } = renderHook(() => useResource(options));
    act(() => {
      result.current.load({});
